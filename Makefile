...
GCC=g++
GCCFLAGS=-Wall -Wextra -std=c++14 -Wold-style-cast -Woverloaded-virtual -Wsign-promo  -Wctor-dtor-privacy -Wnon-virtual-dtor  -Weffc++ -pedantic
GCCOPTIMIZE=-O3
OBJECTS0= ./src/Support.cpp
